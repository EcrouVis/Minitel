...
gcc -I./include -I./include/imgui -I./include/miniaudio -I./include/cJSON ./test/test.cpp ./obj/*.o ./src/circuit/CPLD/*.cpp ./src/circuit/SRAM_64k/*.cpp ./src/circuit/ROM_256k/*.cpp ./src/circuit/TS9347/*.cpp ./src/circuit/80C32/*.cpp ./src/*.cpp ./src/miniaudio/miniaudio.c ./src/cJSON/cJSON.c -L./lib -lglfw3 -lgdi32 -lstdc++ -lWs2_32 -static -o ./test/test.exe -D_GLIBCXX_DEBUG -D_GLIBXX_DEBUG_PEDANTIC -g -Wall -Wextra -Og -Wno-unused-parameter -Wno-unused-function -gdwarf-2
:: -mwindows
